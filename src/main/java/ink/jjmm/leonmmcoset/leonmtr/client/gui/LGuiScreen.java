...
public class LGuiScreen extends AbstractContainerScreen<LGuiMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.leonmtr.l_gui.label_fast_command_menu"), 44, 15, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.leonmtr.l_gui.label_empty"), 8, 117, -12829636, false);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + 25, this.topPos + 36, 134, 20).build();
		...
		}).bounds(this.leftPos + 68, this.topPos + 133, 46, 20).build();
