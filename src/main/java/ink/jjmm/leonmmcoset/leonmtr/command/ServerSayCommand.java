...
public class ServerSayCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("serversay").requires(s -> s.hasPermission(4)).then(Commands.argument("content", MessageArgument.message()).executes(arguments -> {
