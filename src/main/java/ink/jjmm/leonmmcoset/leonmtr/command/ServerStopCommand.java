...
public class ServerStopCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("serverstop").requires(s -> s.hasPermission(4)).then(Commands.argument("reason", MessageArgument.message()).executes(arguments -> {
