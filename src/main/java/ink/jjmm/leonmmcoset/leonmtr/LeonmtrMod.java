package ink.jjmm.leonmmcoset.leonmtr;
...
@Mod("leonmtr")
public class LeonmtrMod {
	public static final Logger LOGGER = LogManager.getLogger(LeonmtrMod.class);
	public static final String MODID = "leonmtr";
	...
	public LeonmtrMod() {
		...
		LeonmtrModMenus.REGISTRY.register(bus);
