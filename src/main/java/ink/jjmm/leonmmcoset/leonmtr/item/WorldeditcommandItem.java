...
import ink.jjmm.leonmmcoset.leonmtr.item.inventory.WorldeditcommandInventoryCapability;

public class WorldeditcommandItem extends Item {
	public WorldeditcommandItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("创世神辅助木斧");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new WorldeditcommandGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new WorldeditcommandInventoryCapability();
	}
