...
public class ReplacegoodbyeProcedure {
	public static void execute(Entity entity, HashMap guistate) {
		...
		if (guistate.containsKey("checkbox:tianchongfangkuainbt") && ((Checkbox) guistate.get("checkbox:tianchongfangkuainbt")).selected()) {
			{
				...
				entity.getCapability(LeonmtrModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.worldeditcommandr1 = _setval;
		...
		if (guistate.containsKey("checkbox:tianchongfangkuainbt2") && ((Checkbox) guistate.get("checkbox:tianchongfangkuainbt2")).selected()) {
			{
				double _setval = 1;
				entity.getCapability(LeonmtrModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.worldeditcommandr2 = _setval;
					capability.syncPlayerVariables(entity);
				});
			}
		} else {
